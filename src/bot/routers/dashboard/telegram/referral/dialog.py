...
referral = Window(
    ...
    Row(
        SwitchTo(
            ...
            id="level",
            state=TelegramReferral.LEVEL,
        ),
        SwitchTo(
            text=I18nFormat("btn-referral-reward-type"),
            id="reward_type",
            state=TelegramReferral.REWARD_TYPE,
        ),
    ),
    Row(
        SwitchTo(
            ...
            id="accrual_strategy",
            state=TelegramReferral.ACCRUAL_STRATEGY,
        ),
    ),
    Row(
        SwitchTo(
            ...
            id="reward_strategy",
            state=TelegramReferral.REWARD_STRATEGY,
        ),
    ),
    Row(
        SwitchTo(
...
reward_manual_input = Window(
    ...
    IgnoreUpdate(),
    state=TelegramReferral.REWARD_MANUAL_INPUT,
)
...
invite_message = Window(
    ...
    Row(
        SwitchTo(
            ...
            id="edit",
            state=TelegramReferral.INVITE_MESSAGE_EDIT,
        ),
    ),
    Row(
        Button(
