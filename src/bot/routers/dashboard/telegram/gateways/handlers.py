...
from src.bot.states import TelegramGateways, DashboardSettings
...
async def on_gateway_select(
    ...
    await sub_manager.switch_to(state=TelegramGateways.SETTINGS)
...
async def on_field_select(
    ...
    await dialog_manager.switch_to(state=TelegramGateways.FIELD)
...
async def on_field_input(
    ...
    await dialog_manager.switch_to(state=TelegramGateways.SETTINGS)
...
async def on_currency_cancel(
    ...
    await dialog_manager.switch_to(TelegramGateways.MAIN)
