...
extra_devices = Window(
    ...
    IgnoreUpdate(),
    state=DashboardTelegram.EXTRA_DEVICES,
...
extra_devices_price = Window(
    ...
    IgnoreUpdate(),
    state=DashboardTelegram.EXTRA_DEVICES_PRICE,
...
extra_devices_price_manual = Window(
    ...
    IgnoreUpdate(),
    state=DashboardTelegram.EXTRA_DEVICES_PRICE_MANUAL,
    getter=extra_devices_price_getter,
)
