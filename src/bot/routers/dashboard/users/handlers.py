...
async def on_user_select(
    ...
    # Determine source state based on current state
    current_state = dialog_manager.current_context().state
    source_map = {
        DashboardUsers.RECENT_REGISTERED: "recent_registered",
        DashboardUsers.RECENT_ACTIVITY: "recent_activity",
        DashboardUsers.ALL_USERS: "all_users",
        DashboardUsers.SEARCH_RESULTS: "search_results",
        DashboardUsers.BLACKLIST: "blacklist",
    }
    source_state = source_map.get(current_state, None)
