...
async def subscription_getter(
    ...
    **kwargs: Any,
    ...
    return {
        ...
        "plan_price": "—",  # Price not stored for existing subscriptions
...
async def squads_getter(
    ...
    **kwargs: Any,
    ...
    external_squad_name = (
        external_dict.get(external_squad_uuid) if external_squad_uuid else False
    )
...
async def referrals_list_getter(
    ...
    **kwargs: Any,
    ...
    for ref in referrals:
        ...
        total_earned = await referral_service.get_rewards_total_by_referral_id(
