...
from src.core.enums import Currency, ReferralRewardType
from src.core.utils.balance import format_balance
...
def build_user_profile_data(
    ...
    Args:
        ...
        currency_rates: CurrencyRatesDto for conversion
    ...
    return {
        ...
        "balance": format_balance(user.balance, currency, currency_rates),
        "referral_balance": format_balance(referral_balance, currency, currency_rates),
