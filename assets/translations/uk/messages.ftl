...
msg-mirror-bots =
    ...
    <blockquote>Тут можна додати дзеркальних ботів.

Натисніть на бота, щоб призначити його <b>основним</b> — запрошувальні посилання вестимуть на нього. Основний бот показаний у [дужках].</blockquote>
