...
msg-user-main-balance =
    ...
    Натисніть <b>✅ Прийняти</b> для підтвердження.
...
msg-subscription-promocode =
    ...
    Також ви можете ввести <b>реферальний код</b> іншого користувача, щоб прив'язатися до нього.
...
msg-extra-device-deletion-confirm = ⚠️ Додаткові пристрої будуть видалені { $expires_date }.
    ...
    Натисніть кнопку видалення повторно для підтвердження.и.
    Пристрій працюватиме до кінця оплаченого терміну.
