...
msg-mirror-bots =
    ...
    <blockquote>Здесь вы можете добавить дополнительных ботов-зеркал.

Нажмите на бота, чтобы назначить его <b>основным</b> — тогда пригласительные ссылки будут вести именно на него. Бот отмечен как основной если его имя в [скобках].</blockquote>
