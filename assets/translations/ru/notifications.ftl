...
ntf-no-subscription-for-devices = <i>⚠️ Для увеличения лимита устройств необходимо иметь активную подписку.</i>

ntf-no-subscription-for-connect = <i>⚠️ Для подключения необходимо сначала получить подписку.</i>
