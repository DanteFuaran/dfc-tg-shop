...
msg-mirror-bots =
    ...
    <blockquote>Here you can add mirror bots. Tap a bot to set it as <b>primary</b> — invite links will point to it. The primary bot is shown in [brackets].</blockquote>
...
msg-subscription-renew-success = ✅ <i>Your subscription has been extended by { $added_duration }.</i>
...
msg-subscription-details =
    ...
    { $devices ->
    [0] { empty }
    *[HAS] • <b>Device limit</b>: { $devices }
    }{ $has_planned_extra_devices ->
        [1] {""}
    • <b>Extra devices:</b> { $planned_extra_devices }
        *[0] {""}
    }
    { $period ->
    [0] { empty }
...
msg-subscription-confirm-balance =
    ...
    { $purchase_type ->
        [CHANGE] 
    ⚠️ <i>Current subscription will be replaced without recalculating remaining time.</i>
        *[OTHER] {""}
    }
...
msg-add-device-payment-link = <b>💳 Payment Link</b>
