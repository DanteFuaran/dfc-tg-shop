...
hdr-subscription = <b>💳 Ihr Abonnement:</b>
hdr-plan = <b>💳 Abonnement:</b>
...
frg-user-details =
    ...
    • <b>Language</b>: { language }{ $is_referral_enable ->
        ...
        *[0] {""}
        ...
        [1] {"\u000A"}• <b>Einlader</b>: <a href="tg://user?id={ $referrer_tg_id }">{ $referrer_name }</a>{ $referrer_username ->
            [0] {""}
...
frg-purchase-confirm-header =
    { $purchase_type ->
    [RENEW] <b>🛒 Bestätigung der Abonnementverlängerung</b>
    [CHANGE] <b>🛒 Bestätigung der Abonnementänderung</b>
    *[OTHER] <b>🛒 Bestätigung des Abonnementkaufs</b>
    }

# Fragment: Benutzerinformationen ohne blockquote (für Bestätigungsnachrichten)
frg-user-info-inline =
    • <b>ID</b>: <code>{ $user_id }</code>
    • <b>Name</b>: { $user_name }{ $is_referral_enable ->
        [1] {"\u000A"}• <b>Empfehlungscode</b>: <code>{ $referral_code }</code>
        *[0] {""}
    }{ $discount_value ->
        [0] {""}
        *[other] {"\u000A"}• <b>Rabatt</b>: { $discount_value }%{ $discount_is_permanent ->
            [1] {" "}(Dauerhaft)
            *[0] { $discount_remaining ->
                [0] {" "}(Einmalig)
...
# Fragment: Abonnement ohne blockquote (für Bestätigungsnachrichten)
frg-subscription-inline =
    • <b>Tarif:</b> { $current_plan_name }
    • <b>Datenvolumen-Limit</b>: { $traffic_limit }
    • <b>Geräte-Limit</b>: { $device_limit_number }{ $device_limit_bonus ->
        [0] {""}
        *[other] +{ $device_limit_bonus }
    }{ $extra_devices ->
        [0] {""}
        *[other] {" "}(+{ $extra_devices } zusätzl.)
    }
    • <b>Verbleibend</b>: { $expire_time }
...
settings-type-percent = Prozentual
settings-type-fixed = Festbetrag

# Commission Values
settings-commission-free = Kostenlos

# Discount Values
settings-discount-none = Kein Rabatt

# Stack Mode
settings-stack-mode-stacked = Gestapelt
settings-stack-mode-max = Maximum

# Apply To
settings-apply-subscription = Abonnement
settings-apply-extra-devices = Zusätzliche Geräte
settings-apply-commission = Provision
settings-apply-nothing = Nichts

# Plan Status
settings-subscription-activated = Abonnement aktiviert